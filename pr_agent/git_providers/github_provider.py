...
from ..algo.utils import PrReviewTitles, load_large_diff, clip_tokens, find_line_number_of_relevant_line_in_file
...
class GithubProvider(GitProvider):
    ...
    def get_previous_review(self, *, full: bool, incremental: bool):
        ...
        prefixes = []
        if full:
            prefixes.append({PrReviewTitles.REGULAR})
        if incremental:
            prefixes.append({PrReviewTitles.INCREMENTAL})
